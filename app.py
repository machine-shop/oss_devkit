...
def main():
    ...
    out = template.render({'week_old': list_of_prs, 'no_discussion': no_diss, 'active_prs': popular, 'oldest_prs': oldest, 'my_prs': mine, 'unmergeable_prs': unmergeable})
    fname = "./output.html"
